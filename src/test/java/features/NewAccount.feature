...
Feature: Techfios bank and cash New Account Functionality
  ...
  Scenario Outline: User should be able to login with valid credentials
    ...
    Examples: 
      | username          | password |  | accountTitle   | description             | initialBalance | accountNumber | Phone      | internetBankingURL            | 
      | demo@techfios.com | abc123   |  | Saving Account | TechFios Saving Account |           3000 |     123456789 | 5102345689 | https://www.bankofamerica.com |
